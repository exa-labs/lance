...
extracted_toolchain_dir="${output_dir}/toolchain"
...
zig_dir="${extracted_toolchain_dir}/zig-0.16.0"
download \
...
maturin_dir="${extracted_toolchain_dir}/maturin-1.15.0"
download \
...
protoc_dir="${extracted_toolchain_dir}/protoc-24.4"
download \
